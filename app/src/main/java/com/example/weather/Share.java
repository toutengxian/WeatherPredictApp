...
public class Share extends Activity {
    private static final String APP_ID = "1107003170"; //获取的APPID
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //传入参数APPID
        mTencent = Tencent.createInstance(APP_ID, Share.this.getApplicationContext());
    }
    ...
    public void qqShare(View v) {
        ...
        params.putString(QQShare.SHARE_TO_QQ_TITLE, "小U天气");//分享标题
        params.putString(QQShare.SHARE_TO_QQ_SUMMARY,"快把预报分享给你的小伙伴吧！");//要分享的内容摘要
        ...
        mTencent.shareToQQ(Share.this, params, new ShareUiListener());
    }
    ...
    public void qqQzoneShare(View v) {
        ...
        params.putString(QzoneShare.SHARE_TO_QQ_TITLE, "小U天气");//分享标题
        params.putString(QzoneShare.SHARE_TO_QQ_SUMMARY, "快把预报分享给你的小伙伴吧！");//分享的内容摘要
        ...
        mTencent.shareToQzone(Share.this, params, new ShareUiListener());
    }
